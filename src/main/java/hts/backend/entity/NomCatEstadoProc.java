 ...
 */
@Entity
@Table(name = "nom_cat_estado_proc")
public class NomCatEstadoProc implements Serializable {
	private static final long serialVersionUID = 1L;

	private Integer estadoProcId;
	private String cve;
	...
	@Id @Column(name = "ESTADO_PROC_ID") public Integer getEstadoProcId() {
		return estadoProcId;
	}

	public void setEstadoProcId(Integer estadoProcId) {
		this.estadoProcId = estadoProcId;
	}
