...
@Entity
@Table(name = "cat_tipo_ingreso_hosp")
public class CatTipoIngresoHosp {

	private Integer tipoIngresoHospId;
	private String cve;
	...
	@Id @Column(name = "TIPO_INGRESO_HOSP_ID", nullable = false, precision = 0) public Integer getTipoIngresoHospId() {
		return tipoIngresoHospId;
	}

	public void setTipoIngresoHospId(Integer tipoIngresoHospId) {
		this.tipoIngresoHospId = tipoIngresoHospId;
	}
