...
import hts.backend.entity.PacAlergiaPaciente;
...
/**
 * CatAlergia generated by hbm2java
 */
@Entity
@Table(name = "cat_alergia")
public class CatAlergia implements java.io.Serializable {
	...
	private Set<PacAlergiaPaciente> pacAlergiaPacientes = new HashSet<PacAlergiaPaciente>(0);
	...
	@Column(name = "ALERGIA_ID", unique = true, nullable = false, precision = 22, scale = 0)
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "catAlergia")
	public Set<PacAlergiaPaciente> getPacAlergiaPacientes() {
		return this.pacAlergiaPacientes;
	}

	public void setPacAlergiaPacientes(Set<PacAlergiaPaciente> pacAlergiaPacientes) {
		this.pacAlergiaPacientes = pacAlergiaPacientes;
	}
