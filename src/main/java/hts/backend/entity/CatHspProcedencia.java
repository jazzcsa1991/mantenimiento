...
@Entity
@Table(name = "cat_hsp_procedencia")
public class CatHspProcedencia {

	private Integer hspProcedenciaId;
	private String cve;
	...
	@Column(name = "HSP_PROCEDENCIA_ID", nullable = false, precision = 0)
	public Integer getHspProcedenciaId() {
		return hspProcedenciaId;
	}

	public void setHspProcedenciaId(Integer hspProcedenciaId) {
		this.hspProcedenciaId = hspProcedenciaId;
	}
	...
	@ManyToOne
	@JoinColumn(name = "IDIOMA_APP_ID", referencedColumnName = "IDIOMA_APP_ID", nullable = false)
