...
@Entity
@Table(name = "cat_pre_ingreso_prioridad")
public class CatPreIngresoPrioridad {

	private Integer preIngresoPrioridadId;
	private String cve;
	...
	@Column(name = "PRE_INGRESO_PRIORIDAD_ID", nullable = false, precision = 0) public Integer getPreIngresoPrioridadId() {
		return preIngresoPrioridadId;
	}

	public void setPreIngresoPrioridadId(Integer preIngresoPrioridadId) {
		this.preIngresoPrioridadId = preIngresoPrioridadId;
	}
