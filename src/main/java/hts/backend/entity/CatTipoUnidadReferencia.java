 ...
 */
@Entity
@Table(name = "cat_tipo_unidad_referencia")
public class CatTipoUnidadReferencia implements Serializable {
	...
	@Column(name = "TIPO_UNIDAD_REFERENCIA_ID") public Integer getTipoUnidadRefId() {
	...
	@OneToMany(mappedBy = "catTipoUnidadReferencia")
