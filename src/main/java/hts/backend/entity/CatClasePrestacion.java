...
/**
 * CatClasePrestacion generated by hbm2java
 */
@Entity
@Table(name = "nom_cat_clase_prestacion")
public class CatClasePrestacion implements java.io.Serializable {

	/**
	 *
	 */
	private static final long serialVersionUID = 1L;
	private int clasePrestacionId;
	private String cve;
	...
	public CatClasePrestacion() {
	}

	public CatClasePrestacion(int clasePrestacionId, String cve, String nombre, String descripcion,
	...
	@Column(name = "CLASE_PRESTACION_ID", unique = true, nullable = false, precision = 22)
	public int getClasePrestacionId() {
		return this.clasePrestacionId;
	}

	public void setClasePrestacionId(int clasePrestacionId) {
		this.clasePrestacionId = clasePrestacionId;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "catClasePrestacion")
