...
public interface GenericHibernateDAO {
	...
	/**
	 * Flujo completo para actualizar una entidad en la base de datos
	...
	/**
	 * Flujo completo para registrar una entidad en la base de datos
	 * @author Juan Castañeda
	...
	/**
	 * Flujo completo para registrar o actualizar una entidad en la base de datos
	 * @author Juan Castañeda
	 * @param entidad a registrar
	 * @return exito
	 */
	...
	/**
	 * Flujo completo para eliminar una entidad en la base de datos
	 * @author Juan Castañeda
